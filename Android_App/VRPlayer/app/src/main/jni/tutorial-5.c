...
static void *app_function (void *userdata) {
    ...
    /* Build pipeline */
    data->pipeline = gst_parse_launch("udpsrc port=5200 ! application/x-rtp, encoding-name=JPEG,payload=26 ! rtpjpegdepay ! jpegdec ! videoconvert ! autovideosink", &error);
    if (error) {
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass klass = (*env)->FindClass (env, "com/telekonferencja_vr/VRPlayer");
